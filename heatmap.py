...
def plot_heatmap(excel_file):
    ...
    def plot_heatmap(spike_counts, title_prefix, excel_file, output_dir):
        ...
        plt.title(title_prefix + '_' + excel_file.replace('.xlsx', ''))
        ...
        # Save the plot as an image in the 'heatmap' folder
        image_filename = os.path.join(output_dir, title_prefix + '_' + excel_file.replace('.xlsx', '.png'))
